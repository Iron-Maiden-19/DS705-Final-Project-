...
Bad_or_Good99 <- ifelse(probabilities>th5,1,0)
Bad_or_Good5 <-  as.factor(Bad_or_Good99)
c5 <- confusionMatrix(data=Bad_or_Good5,reference=Loan_test$status2)
...
p2 <- ggplot(data = acc_thr_df, mapping = aes(x =Accuracy  , y = Threshold)) + 
  geom_point(shape = 18, color = "green", size = 5) +labs(x = " Accuracy", y = "Threshold ",title="Accuracy percentage by Threshold" )  
